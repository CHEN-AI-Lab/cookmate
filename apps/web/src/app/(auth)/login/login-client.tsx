      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full">
        ...
        <div className="grid grid-cols-3 gap-2">
          ...
          <button
            ...
            className="flex items-center justify-center gap-1.5 border border-gray-200 rounded-xl py-2.5 hover:bg-gray-50 transition-colors disabled:opacity-50 text-sm"
          >
            <svg viewBox="0 0 24 24" className="w-4 h-4 shrink-0" fill="#1677FF"><path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm4.92 14.5c-.2.3-.5.5-.9.5H6.9c-.4 0-.7-.2-.9-.5-.2-.3-.2-.7-.1-1l.9-3.1h7.4c.3 0 .5-.2.5-.5s-.2-.5-.5-.5H7.5l1.5-5.1c.1-.3.3-.5.6-.5h6.2c.3 0 .5.2.5.5s-.2.5-.5.5H10.3l-1.2 4.1h6.2c.3 0 .5.2.5.5s-.2.5-.5.5H9.5l-.8 2.8h7.4c.3 0 .5.2.5.5 0 .1 0 .3-.1.4z"/></svg>
