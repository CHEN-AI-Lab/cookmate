      ...
      <div className="bg-card rounded-2xl shadow-2xl p-8 max-w-md w-full ring-1 ring-orange-100/50">
        ...
        {isLoggedIn && (
          <div className="mb-4 p-4 bg-amber-500/10 border border-amber-500/30 rounded-xl">
            ...
            <p className="text-xs text-amber-500/70 mt-1">{t('switchAccountForRegister')}</p>
        ...
        <div className="space-y-4">
          ...
          {emailCodeSent && (
            <button
              ...
              className="w-full bg-accent text-white rounded-xl py-3 font-medium hover:bg-orange-600 disabled:bg-surface disabled:text-text-secondary transition-all"
            >
