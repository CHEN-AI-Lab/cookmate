      ...
      <div className="bg-card rounded-2xl shadow-2xl p-8 max-w-md w-full ring-1 ring-orange-100/50">
        ...
        {isLoggedIn && (
          <div className="mb-4 p-4 bg-amber-50 border border-amber-200 rounded-xl">
            ...
            <p className="text-xs text-amber-700/70 mt-1">{t('switchAccount')}</p>
        ...
        {showOauthError && (
          <div className="relative mb-6 p-3 pr-8 rounded-xl bg-red-50 border border-red-200 text-xs text-red-600 leading-relaxed">
            <button
              type="button"
              onClick={dismissOauthError}
              aria-label={tc('close')}
              className="absolute top-2 right-2 w-5 h-5 flex items-center justify-center rounded-full text-red-600/60 hover:text-red-600 hover:bg-red-50 transition-colors"
            >
            ...
            <div>
              ...
              <div className="flex gap-2 mt-1.5">
                <input
                  ...
                  className="flex-1 border border-gray-100 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent/20 bg-card"
                />
                <button
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-100 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent/20 bg-card mt-1.5"
                  />
                </div>
                {error && tab === "email" && (
                  <div className={`text-xs rounded-xl px-3 py-2 ${
                    error.includes("dev") ? "bg-green-50 border border-green-200 text-green-600"
                    : error.includes("sent") ? "bg-amber-50 border border-amber-200 text-amber-700"
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                value={email}
                onChange={(e) => setEmail(e.target.value)}
                className="w-full border border-gray-100 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-accent bg-card mt-1.5"
              />
            </div>
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 border border-gray-100 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-accent bg-card"
                maxLength={6}
              />
              <button
        ...
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className="flex items-center justify-center gap-1.5 border border-gray-100 rounded-xl py-2.5 hover:bg-surface transition-colors disabled:opacity-50 text-sm"
          >
