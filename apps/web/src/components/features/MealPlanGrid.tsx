  ...
  return (
    <div className="space-y-3">
      {DAY_LABELS.map((day, dayIdx) => (
        ...
        >
          <div className="bg-accent-soft text-accent px-4 py-2 font-bold text-sm dark:bg-accent/15 dark:text-accent">{day}</div>
            ...
            {MEAL_TYPES.map((meal) => {
              ...
              return (
                <button
                  ...
                  className="p-3 text-left hover:bg-accent/5 transition-colors min-h-[70px]"
                >
