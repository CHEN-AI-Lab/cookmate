...
function getMockRecipes(
  ...
  const all: RecipeResult[] = [
    ...
    { title: "辣椒炒肉", description: "经典湘菜，香辣下饭", ingredients: ["五花肉 150g", "青椒 2个", "红椒 1个", "大蒜 3瓣", "酱油 15ml", "油 10ml", "盐 适量"], steps: ["五花肉切薄片", "青红椒切圈，大蒜切片", "热锅不放油，煸炒五花肉出油至微焦", "加入蒜片和辣椒翻炒", "加酱油和盐调味出锅"], cookingTime: 12, calories: 420, cuisineType: "湘菜", difficulty: "easy" },
